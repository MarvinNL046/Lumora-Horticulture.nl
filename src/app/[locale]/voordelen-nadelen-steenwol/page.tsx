...
const article: Record<StorefrontLocale, KnowledgeArticle> = {
  nl: {
    ...
    sections: [
      ...
      { kind: 'prose', title: 'Conclusie', paragraphs: ['Voor professionele telers wegen de voordelen zwaar: de controle, de consistente kwaliteit en de bewezen resultaten maken steenwol een veelgebruikte keuze in de opkweek. De nadelen zitten vooral in de leercurve en de aanschaf.', ["De pluggen hebben een Ellepot FP 12+ papierwikkel. Lees meer over de ",{"text":"samenstelling van paperbus steenwol pluggen","href":"/paperbus-steenwol-pluggen"}," en het verschil tussen de kern en de wikkel."]] },
      {"kind":"prose","title":"Van materiaal naar stekplug","paragraphs":[["Voor zaaien en stekken vind je bij ons ",{"text":"steenwol stekpluggen in trays van 84 of 104 cellen","href":"/stekpluggen-steenwol"},". Bekijk de plugmaten en doosinhoud om de passende uitvoering te kiezen."],["Wil je weten hoe je de trays gebruikt? Lees de ",{"text":"handleiding voor steenwol stekpluggen","href":"/paper-plug-trays-uitgelegd"}," voor het natmaken, inzetten en uitplanten."]]},
    ],
  ...
  en: {
    ...
    sections: [
      ...
      { kind: 'prose', title: 'Conclusion', paragraphs: ['For professional growers the advantages carry weight: control, consistent quality and proven results make rockwool a common choice for propagation. The disadvantages are mainly the learning curve and the purchase cost.', ["The plugs have an Ellepot FP 12+ paper sleeve. Read about the ",{"text":"materials used in paper pot rockwool plugs","href":"/paperbus-steenwol-pluggen"}," and the difference between the core and the sleeve."]] },
      {"kind":"prose","title":"From material to propagation plug","paragraphs":[["For sowing and cuttings, explore our ",{"text":"rockwool plugs in 84- or 104-cell trays","href":"/stekpluggen-steenwol"},". Compare plug sizes and box contents to choose the right version."],["Getting started with the trays? Read our ",{"text":"guide to using rockwool propagation plugs","href":"/paper-plug-trays-uitgelegd"}," for practical information on propagation."]]},
    ],
  ...
  de: {
    ...
    sections: [
      ...
      { kind: 'prose', title: 'Fazit', paragraphs: ['Für professionelle Züchter wiegen die Vorteile schwer: Kontrolle, konstante Qualität und bewährte Ergebnisse machen Steinwolle zu einer gängigen Wahl in der Anzucht. Die Nachteile liegen vor allem in der Lernkurve und der Anschaffung.', ["Die Stecker haben eine Ellepot FP 12+ Papierhülle. Lesen Sie mehr über die ",{"text":"Materialien der Papiertopf-Steinwollstecker","href":"/paperbus-steenwol-pluggen"}," und den Unterschied zwischen Kern und Hülle."]] },
      {"kind":"prose","title":"Vom Material zum Anzuchtstecker","paragraphs":[["Für Aussaat und Stecklinge finden Sie bei uns ",{"text":"Steinwollstecker in Platten mit 84 oder 104 Zellen","href":"/stekpluggen-steenwol"},". Vergleichen Sie Plugmaße und Kartoninhalt, um die passende Ausführung zu wählen."],["Sie möchten die Platten verwenden? Lesen Sie unsere ",{"text":"Anleitung für Steinwollstecker","href":"/paper-plug-trays-uitgelegd"}," mit praktischen Informationen zur Anzucht."]]},
    ],
