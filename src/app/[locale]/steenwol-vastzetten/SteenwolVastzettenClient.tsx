    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <Image src="/productAfbeeldingen/trays/tray84/lumorahorticulture-tray84.jpg" alt="Steenwol Pluggen" width={800} height={400} className="rounded-2xl shadow-2xl mx-auto" />
        </div>
      </section>
