...
export default function ProductPageClient({ locale, productSlug }: ProductPageClientProps) {
  ...
  const t = {
    ...
    trayBoxNote84: locale === 'de' ? '1 Karton: 8 Trays · 672 Zellen' : locale === 'en' ? '1 box: 8 trays · 672 cells' : '1 doos: 8 trays · 672 cellen',
    trayBoxNote104: locale === 'de' ? '1 Karton: 7 Trays · 728 Zellen' : locale === 'en' ? '1 box: 7 trays · 728 cells' : '1 doos: 7 trays · 728 cellen',
