...
export const neemx: ProductFamily = {
  ...
  description:
    'NeemXPRO is een hooggeconcentreerde botanische olieblend voor de verzorging en gelijkmatige behandeling van het bladoppervlak. De formule is goed te verdelen in water en verkrijgbaar in 10, 30 en 50 ml.',
  ...
  mainImageAlt: 'NeemXPRO assortiment op travertijn met neem-bladeren en witte bloesem',
  secondaryImage: '/productAfbeeldingen/neemxpro/neemx-pro-50ml-travertijn-sokkel.webp',
  secondaryImageAlt: 'NeemXPRO 50 ml flesje op een stenen sokkel met neem-bladeren rondom',
  tertiaryImage: '/productAfbeeldingen/neemxpro/neemx-pro-50ml-leisteen-donker.webp',
  tertiaryImageAlt: 'NeemXPRO 50 ml flesje op donkere natte leisteen met neem-bladeren',
  usageImage: '/productAfbeeldingen/neemxpro/neemx-pro-hero-marmer-neem-tak.webp',
  usageImageAlt: 'NeemXPRO flesjes in drie formaten op een marmeren blad met een neem-tak',
  variants: [
