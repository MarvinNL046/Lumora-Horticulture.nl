...
export function ProductDetail({ product, locale = 'nl' }: { product: ProductFamily; locale?: StorefrontLocale }) {
  ...
  const paperbusHeading = locale === 'de'
    ...
    <main>
      ...
      <section className={`${styles.container} ${styles.pdpGrid}`}>
        ...
        <div className={`${styles.productSummary} ${styles[`productSummary_${product.id}`]}`} id="koopblok">
          ...
          <h1>{isPaperbus ? paperbusHeading : 'NeemXPRO'}</h1>
