...
const LEGACY_BASE_PATH_ALIASES: Record<string, string> = {
  ...
  // Legacy knowledge pages retired in September 2026 (3 clicks in 16 months).
  '/technische-specs/84-vs-104-vergelijking': '/stekpluggen-steenwol',
  '/technische-specs/celgroottes-toepassingen': '/stekpluggen-steenwol',
  '/products/ellepot-fp12': '/stekpluggen-steenwol',
  '/steenwol-pluggen': '/stekpluggen-steenwol',
  '/stekpluggen': '/stekpluggen-steenwol',
  '/duurzaamheid/carbon-footprint-kweekmateriaal': '/paper-plug-trays-uitgelegd',
  '/duurzaamheid/composteerbaarheid-praktijk': '/paper-plug-trays-uitgelegd',
  '/innovatie-trends/verticale-teelt-paper-plugs': '/paper-plug-trays-uitgelegd',
  '/innovatie-trends/automatisering-propagatie': '/paper-plug-trays-uitgelegd',
  '/efficiëntie-roi/arbeidsbesparing-40-procent': '/paper-plug-trays-uitgelegd',
  '/efficiëntie-roi/roi-berekenen': '/paper-plug-trays-uitgelegd',
  '/praktische-toepassingen/paper-plugs-groenteteelt': '/applications',
  '/praktische-toepassingen/paper-plugs-sierplanten': '/applications',
  '/regionale-markten/nederlandse-glastuinbouw': '/applications',
  '/regionale-markten/duitse-gaertnerei': '/applications',
  '/supply-chain/inkoop-leveranciersselectie': '/levensduur-steenwol',
  '/supply-chain/opslag-houdbaarheid': '/levensduur-steenwol',
  '/steenwol-substraat': '/voordelen-nadelen-steenwol',
  '/bol-handleiding': '/products',
}
